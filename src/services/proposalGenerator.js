...
import { buildSectionContext, buildGenerateSectionPrompt, buildReviseSectionPrompt } from '../config/sectionPrompts';
...
export async function generateAllSections(apiKey, proposalInstanceId, onProgress) {
  ...
  try {
    ...
    const { proposalInstances } = await import('./database');
